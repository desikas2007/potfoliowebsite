...
export default function Contact() {
  const email = "GET IN TOUCH";
  const googleForm = "https://docs.google.com/forms/d/e/1FAIpQLSew-QhFrSl-aIQDD5D4G4xrUn198eDMv_yEs5t-11l_kYk59Q/viewform?usp=publish-editor";
  const github = "https://github.com/desikas2007";
  const linkedin = "https://www.linkedin.com/in/desika-s-370b55363?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app";
  ...
  return (
    <div className="contact-page">
      ...
      <footer>© 2025 Desika | All Rights Reserved</footer>
    </div>
  );
}
